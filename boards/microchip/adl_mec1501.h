...
#define HOME_BUTTON			EC_GPIO_064
...
#define TOP_SWAP_OVERRIDE		EC_GPIO_244
...
#define G3_SAF_DETECT			EC_GPIO_PORT_PIN(EC_EXP_PORT, 0x04)
#define THERM_STRAP			EC_GPIO_PORT_PIN(EC_EXP_PORT, 0x05)
#define PECI_OVER_ESPI			EC_GPIO_PORT_PIN(EC_EXP_PORT, 0x06)
#define TIMEOUT_DISABLE			EC_GPIO_PORT_PIN(EC_EXP_PORT, 0x07)
