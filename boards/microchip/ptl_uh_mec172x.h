...
#ifndef __MEC172x_PTL_UH__
#define __MEC172x_PTL_UH__

#define KSC_PLAT_NAME		"PTL_UH"
...
/* Signal to gpio mapping for MEC1728 based PTL UH is described here */
#define HOME_BUTTON			EC_GPIO_000

#define PS2_KB_DATA			EC_GPIO_010
#define PM_PWRBTN			EC_GPIO_011
...
#define MOD_TCSS_EC_SX_CNTRL		EC_GPIO_024
...
#define PWRBTN_EC_IN_N			EC_GPIO_106

#define KBC_CAPS_LOCK			EC_GPIO_127
#define TYPEC_EC_SMBUS_ALERT_0_R	EC_GPIO_143
#define EC_PG3_EXIT			EC_GPIO_144

#define KBD_BKLT_CTRL			EC_GPIO_153
#define PM_BAT_STATUS_LED1		EC_GPIO_156
#define PM_BAT_STATUS_LED2		EC_GPIO_157
#define KBC_NUM_LOCK			EC_GPIO_154
#define BC_ACOK				EC_GPIO_155
...
#define EC_PWRBTN_LED			EC_GPIO_241

#define EC_PCH_DEBUG			EC_DUMMY_GPIO_HIGH
#define VOL_UP				EC_GPIO_242
#endif
#define STD_ADP_PRSNT			EC_GPIO_243

#define TOP_SWAP_OVERRIDE_GPIO		EC_GPIO_244

#define VOL_DOWN			EC_GPIO_246

#define STD_ADPT_CNTRL_GPIO		EC_GPIO_254
#define CATERR_LED_DRV			EC_GPIO_255
...
/* Pin2 is named as VAL_PECI_ESPI in schematics but using this EC_EMUL_HW_STRAP */
#define PNP_NPNP_SKU			EC_GPIO_PORT_PIN(EC_EXP_PORT_2, 0x02)
...
#define EC_EMUL_HUB			DT_NODELABEL(ec_emul_hub0)
#define PECI_EMUL			DT_NODELABEL(peci_emul0)
