...
#ifndef __COMMON_NPCX_H__
#define __COMMON_NPCX_H__

/* GPIO expander ports, offset from valid gpios */
#define EC_EXP_PORT_1			NPCX_NUM_GPIO_PORTS
#define EC_EXP_PORT_2			(EC_EXP_PORT_1 + 1U)

/* Dummy gpio port */
#define EC_DUMMY_GPIO_PORT		(EC_EXP_PORT_2 + 1U)
