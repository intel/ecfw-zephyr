...
The MEC1501 is a development platform.

.. image:: ./mec1501_euclid.png
     :width: 600px
     :align: center
...
The mec1501_euclid board configuration supports the following hardware
features:
...
:zephyr_file:`boards/arm/mec1501_ADL/mec1501_ADL_defconfig`
Kconfig file.
...
#. Connect the MEC15xxEVB_ASSY_6853 board to your host computer using the
   ...
   You should see ``"Hello World! mec1501_euclid"`` in your terminal.
