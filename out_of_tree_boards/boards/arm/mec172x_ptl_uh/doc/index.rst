...
The MEC172X PTL UH is Intel referance platform for Pantherlake.
...
The mec172x_ptl_uh board configuration supports the following hardware
features:
...
:zephyr_file:`boards/arm/mec172x_ptl_uh/mec172x_ptl_uh_defconfig`
Kconfig file.

Connections and IOs
===================

Please refer PTL UH rvp schematics for EC gpio allocations and IOs.
